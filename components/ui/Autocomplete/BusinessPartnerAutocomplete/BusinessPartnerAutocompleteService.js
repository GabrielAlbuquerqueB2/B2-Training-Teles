...
export async function getBPListByDescription(description) {
    ...
    const query = new Api()
        ...
        .setParams({
            ...
            $filter: `CardType eq 'cSupplier' and Valid eq 'tYES' and (contains(CardCode, '${uppercaseDescription}') or contains(CardName, '${uppercaseDescription}') or contains(FederalTaxID, '${uppercaseDescription}'))`
        })
        .get()
...
export async function getCustomerByDescription(description) {
