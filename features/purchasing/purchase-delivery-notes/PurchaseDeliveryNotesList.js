...
export default function PurchaseDeliveryNotesList(props) {
    ...
    function SaveButton(params) {    
        return (
            <Button
                id={params.data.id}
                onClick={() => {
                    router.push(`/purchasing/purchase-delivery-notes/edit/${params.data.DocNum}`)
                }}
            >
                Editar
            </Button>
            ...
            <div className='ag-theme-alpine' style={{ height: 730 }}>
                <AgGridReact                    
                    ...
                    columnDefs={[
                        ...
                        { headerName: 'NF', field: 'SequenceSerial' },                 
