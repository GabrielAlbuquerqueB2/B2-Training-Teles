...
import { getAllPurchaseRequests } from '../purchase-request/PurchaseRequestServices'

export default function PurchaseRequestListFilters(props) {
    ...
    async function handleFilter() {
        ...
        const result = await getAllPurchaseRequests(uniqueBranchList, props.filters)
