...
import { getAllGoodsReceivedNotesWithDetails } from './GoodsReceivedNoteServices'

export default function GoodsReceivedNoteListFilters(props) {

    async function handleFilter() {
        const result = await getAllGoodsReceivedNotesWithDetails(props.filters)
