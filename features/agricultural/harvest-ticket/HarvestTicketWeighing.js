...
export default function HarvestTicketWeighing(props) {
    ...
    useEffect(() => {
        if (props.data.B2AG_PKL2Collection && !props.isThirdPartTicket) {
            const mappedObject = props.data.B2AG_PKL2Collection.map(item => {
            ...
            props.setField("B2AG_PKL2Collection", mappedObject)
        }
