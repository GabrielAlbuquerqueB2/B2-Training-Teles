...
import ItemAutocompleteByGroupCode from '../../../components/ui/Autocomplete/ItemAutocompleteByGroupCode'
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={3}>
                        <Select
                            name="Cultivation"
                            label="Cultura"
                            list={props.cultivations}
                            value={props.data.Cultivation}
                            setState={props.setField}
                        />
                    </Grid>
                    <Grid item xs={6}>
                        <ItemAutocompleteByGroupCode
                            name="Item"
                            value={props.item}
                            setValue={props.setItem}
                            groupCode={props.data.Type}
                        />
                    </Grid>
                    <Grid item xs={2}>
                        <TextField
                    ...
                    <Grid item xs={2}>
                        <CurrencyTextField
                            ...
                            onChange={(evt, newValue) => props.setField('Quantity', newValue)}
                        />
                    </Grid>
                    <Grid item xs={12}>
                        <Select
